...
const RoleCard: React.FC<{
    ...
    <div
        className={`cursor-pointer rounded-xl border-2 transition-all p-6 shadow-md hover:bg-[#fad02c] hover:text-black hover:border-[#fad02c] ${
            selected
                ? "bg-[#fad02c] text-black border-[#fad02c]"
    ...
    >
        <div className="flex flex-col items-center gap-2">
            ...
            <div className="text-sm text-center opacity-80">{description}</div>
        </div>
    </div>
);
...
const JoinEn: React.FC = () => {
    ...
    return submitted ? (
        <section
            id="join"
            className="mt-16 py-16 px-4 max-w-4xl mx-auto rounded-xl flex flex-col items-center justify-center min-h-[60vh] bg-[#333652] transition-colors duration-700"
        >
            <img
        ...
        <section id="join" className="py-16 px-4 max-w-4xl mx-auto">
            ...
            <div className="text-center mb-6">
                <div>
                    ...
                    paints mainstream. Want to help? You don’t need a PhD — just
                    passion.
                </div>
            </div>
